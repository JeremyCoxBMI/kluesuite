 ...
 * Generates random keys and then tests speed using sequential reads
 *
 */
public class DebianRandomDatabaseSequentialTestAllDrives {
...
//        printArray(fakeValues,5);
        ...
        stdout.print("\n\n");
        stdout.println(tt.toHMS()+"\tTesting all databases with sorted keys\t" + new Timestamp(System.currentTimeMillis()));
