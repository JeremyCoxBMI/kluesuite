...
import org.cchmc.kluesuite.socketklue.server.response.LongListListResponse;
 ...
 */
@AllArgsConstructor
public class GetAllHandler extends KlueProtoCodexHandler {
    ...
    protected void call(ByteBuf req, final SocketPacketSink sink) {
        ...
        klue.getAll(keys, new KlueCallback<ArrayList<ArrayList<Long>>>() {
            @Override
            public void callback(ArrayList<ArrayList<Long>> value) {
                sink.sink(new LongListListResponse(value));
            }
